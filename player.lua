...
function Player:new(x,y,z)
    ...
    self.regularJump = love.audio.newSource("assets/Jump_4.wav", "static")
    self.slideJump = love.audio.newSource("assets/Jump_9.wav", "static")
    self.slam = love.audio.newSource("assets/slam.wav", "static")
    self.swoosh = love.audio.newSource("assets/swooosh.wav", "static")
    self.footsteps = love.audio.newSource("assets/footsteps.wav", "static")
    self.slide = love.audio.newSource("assets/slide.wav", "static")
